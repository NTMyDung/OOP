...
int main()
{
    DIEMMAU d(-2.3, 8.9, 56, -117, 200);
    double a,b;
    int select;
    cout<< "-----------CHUONG TRINH XU LY DIEM 2 CHIEU CO MAU----------\n";
    cout<< "0. Thoat CT.\n";
    cout<< "1. Nhap diem.\n";
    cout<< "2. Xuat diem.\n";
    ...
    cout<< "8. Cap nhat lai hoanh do, tung do.\n";
    cout<< "9. Xem hoanh do.\n";
    cout<< "10. Xem tung do.\n";
    cout<< "11. Chu vi va dien tich tam giac qua 3 diem.\n";
    cout<< "12. Cap nhat lai mau Red.\n";
    cout<< "13. Cap nhat lai mau Green.\n";
    cout<< "14. Cap nhat lai mau Blue.\n";
    cout<< "15. Cap nhat lai mau R-G-B.\n";
    cout<< "16. Xem mau Red.\n";
    cout<< "17. Xem mau Green.\n";
    cout<< "18. Xem mau Blue.\n";
    do{
       cout<< "-------------------------------------------------------\n";
       cout<< "Ban chon: ";
       cin>>select;
       switch(select){
        ...
        case 2: cout<<d<<endl;
        break;
        case 3: cout<< "Nhap khoang cach dx, dy can di chuyen: "; cin>>a>>b;
            d.DiChuyen(a,b);
            cout<< "Diem sau khi di chuyen: "<<d<<endl;
            break;
        case 4:
            {
            DIEMM tmp=d.TimDoiXung();
            DIEMM tmp2=DIEMM(d);
        ...
        case 5:
            ...
            DIEMMAU tmp;
            cin>>tmp;
            if(DIEMM(d).KtraTrung(DIEMM(tmp))) cout<< "Diem vua nhap "<<tmp<< " trung toa do voi diem ban dau "<<d<<".\n";
        ...
        break;
        case 9: cout<< "Hoanh do: "<<d.GetX()<<endl;
            break;
        case 10: cout<< "Tung do: "<<d.GetY()<<endl;
            break;
        case 11:
            {
            DIEMM tmp=DIEMM(d);
            ...
            DIEMM d2;
            cin>>d2;
            if(d.KiemTraTamGiacHopLe(d1, d2)){
                cout<< "Tam giac co 3 dinh "<<tmp<<", "<<d1<< ", "<<d2<<endl;
                cout<< "Phan loai: "<<d.PhanLoaiTamGiac(d1, d2)<<endl;
                cout<< "Chu vi tam giac: "<<d.TinhChuViTamGiac(d1,d2)<<endl;
                cout<< "Dien tich tam giac: "<<d.TinhDienTichTamGiac(d1,d2)<<endl;
            }
