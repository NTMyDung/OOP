    ...
    do{
       ...
       switch(select){
        ...
        case 4:
            ...
            cout<< "Diem doi xung cua "<<d<< " la "<<tmp<<endl;
            }
            break;
        case 5:
            {
            ...
            DIEM3C tmp;
            cin>>tmp;
            if(d.KtraTrung(tmp)) cout<< "Diem vua nhap "<<tmp<< " trung voi diem ban dau "<<d<<".\n";
            else cout<< "Diem vua nhap "<<tmp<< " khong trung voi diem ban dau "<<d<<".\n";
            }
        break;
        ...
        case 13:
            {
            cout<< "Nhap them 2 diem de tao voi diem ban dau "<<d<< " thanh 1 tam giac.\n";
            cout<< "Diem thu nhat: \n";
            DIEM3C d1;
            cin>>d1;
            cout<< "Diem thu hai: \n";
